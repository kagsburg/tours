            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="text-primary px-3" href="{{ session('socials.0.facebook') }}"  target="_blank" >
                            <i class="fab fa-facebook-f"></i>
                        </a>                       
                       
                        <a class="text-primary px-3" href="{{ session('socials.0.twitter') }}"  target="_blank">
                            <i class="fab fa-twitter"></i>
                        </a>
                        {{-- <a class="text-primary px-3" href="">
                            <i class="fab fa-linkedin-in"></i>
                        </a> --}}
                        <a class="text-primary px-3" href="{{ session('socials.0.instagram') }}"  target="_blank">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="text-primary pl-3" href="{{  session('socials.0.youtube') }}"  target="_blank">
